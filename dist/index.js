...
var __vue_render__ = function __vue_render__() {
  ...
  return _c('button', {
    "class": ['nice-handsome-button', 'nice-handsome-button--' + _vm.color, 'nice-handsome-button--' + _vm.size, {
...
var NiceHandsomeButton = __vue_normalize__({
